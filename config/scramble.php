...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<MD
# Wemá API — Le cahier qui écoute 🎙️

Bienvenue sur la documentation interactive de l'API Backend **Wemá**, conçue pour l'assistant vocal WhatsApp et le tableau de bord web de gestion des commerces de détail au Bénin.

### 📌 Guide pour l'équipe Frontend (Groupe 1) :
- Tous les montants sont exprimés en **Francs CFA (FCFA)**.
- Les statuts de transaction sont :
  - `CONFIRMED` : Transaction validée (déjà comptabilisée dans le solde client et le stock).
  - `PENDING` : Extraction incertaine / nécessite une **validation ou correction humaine** sur le tableau de bord.
  - `REJECTED` : Transaction annulée ou rejetée.
- Utilisez le bouton **"Try it"** sur chaque endpoint pour tester les requêtes en direct.
MD,
    ],

    'ui' => [
        'title' => 'Wemá API — Documentation Interactive',
    ],
